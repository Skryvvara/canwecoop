    ...
    <div className="container">
      ...
      <section className="card pd-5">
        ...
        <article className={styles.aboutSection}>
          ...
          <p>
            No. The login process is completely handled by steam. We do not have
            access to your steam credentials at any point.
          </p>
        </article>
        <article className={styles.aboutSection}>
          ...
          <ul className={styles.detailsList}>
            ...
            <li>
              <details>
                ...
                <p>
                  The friend list is used to provide the option to filter games
                  you and your friends have in common. Please note that we only
                  store data of friends that are also registered to canwecoop.
                </p>
              </details>
            </li>
            <li>
              <details>
                ...
                <p>
                  We need the list of games of our users to provide the service
                  we want to offer.
                </p>
              </details>
            </li>
